package org.apache.maven.alarmas;
...
import org.apache.maven.dbmanager.DatabaseManagerDAO;
...
//	    detenerAnimacionCargaImagen(cargaImagen); // Detener animación anterior
		...
		InputStream imagenStream = Utilidades.class.getResourceAsStream("/imagenes/cargaImagen.gif");
		Image gif = new Image(imagenStream);
	 ...
	 */
	public static Image cargarGif(String path) {
		InputStream imageStream = Utilidades.class.getResourceAsStream(path);
